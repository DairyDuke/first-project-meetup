...
export const greenBlob = require('./HomePageImages/greenblob.svg');
export const redBlob = require('./HomePageImages/red-blob.svg');
export const yellowBlob = require('./HomePageImages/yellow-blob.svg');
